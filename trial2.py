...
class GUI_app():
    def __init__(self, window_title, width, height):
        ...
        self.submit_btn = Button(self.win, text="Submit", font=('ubuntu',14), bg=BG_button, fg=FG_button,command =lambda:[quickSort(objs),self.result()])
        ...
        self.exit_btn = Button(self.win, text="Exit", font=('ubuntu',14), bg=BG_button, fg=FG_button, command=self.win.destroy)
